    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Route nicht gefunden</h1>
          <p className="text-gray-500 mb-8">Die angeforderte Route existiert nicht.</p>
          <Link
            href="/routen"
          ...
          <div className="p-8 sm:p-10">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="bg-gray-50 rounded-2xl p-5 text-center border border-gray-100">
                ...
                <div className="text-xs text-gray-400 font-medium uppercase tracking-wider mt-1">Kilometer</div>
              </div>
              <div className="bg-gray-50 rounded-2xl p-5 text-center border border-gray-100">
                <div className="text-2xl mb-2">⏱️</div>
                <div className="text-2xl font-bold text-gray-800">{route.duration}</div>
                <div className="text-xs text-gray-400 font-medium uppercase tracking-wider mt-1">Minuten</div>
              </div>
              <div className="bg-gray-50 rounded-2xl p-5 text-center border border-gray-100">
                <div className="text-2xl mb-2">🎯</div>
                <div className="text-lg font-bold text-gray-800">{route.category}</div>
                <div className="text-xs text-gray-400 font-medium uppercase tracking-wider mt-1">Kategorie</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button className="flex-1 bg-gray-800 text-white py-3.5 rounded-xl font-semibold hover:bg-gray-900 transition-colors flex items-center justify-center gap-2">
                <span>🗺️</span>
